  ...
  return (
    <>
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-[rgba(250,250,247,0.78)] border-b border-line">
        <div className="mx-auto w-[min(1100px,100%-48px)]">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-7 text-[14px] font-medium text-ink-muted">
              <Link href="/#api" className="hover:text-ink transition-colors">
                API
              </Link>
              <a
                href="/skill.md"
                className="hover:text-ink transition-colors font-mono text-[13px]"
              >
                skill.md
              </a>
      ...
      <main className="mx-auto w-[min(880px,100%-48px)] py-14 md:py-20">
        {children}
      </main>

      <footer className="mx-auto w-[min(880px,100%-48px)] pb-16 text-caption text-[13px] border-t border-line-soft pt-8">
