...
export default function LegalLayout({
  ...
  return (
    <>
      ...
      <main className="mx-auto w-[min(720px,100%-48px)] py-16 md:py-24">
        <article className="legal">{children}</article>
      </main>

      <footer className="mx-auto w-[min(720px,100%-48px)] pb-16 text-caption text-[13px] border-t border-line-soft pt-8">
